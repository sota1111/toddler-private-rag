...
export const messages: Record<Lang, Messages> = {
  ja: {
    ...
    'create.autoEnrichingLeaveOk': 'このページを離れても整理は続きます。完了すると登録ページ（仮登録一覧）に表示されます。',
    'create.autoSavedTitle': 'アップ完了（仮登録しました）',
    'create.autoSavedDesc': '写真を読み取り、仮登録に保存しました。登録ページで内容を確認のうえ本登録してください。',
    'create.autoSavedNoText': '写真は保存しました。文字の読み取りに失敗しました（仮登録一覧から手入力で編集できます）。',
  ...
  en: {
    ...
    'create.autoEnrichingLeaveOk': 'You can leave this page — organizing continues. When it is done it will appear on the registration page (draft list).',
    'create.autoSavedTitle': 'Upload complete (saved as a draft)',
    'create.autoSavedDesc': 'The photo was read and saved as a draft. Review it on the registration page and finalize it.',
    'create.autoSavedNoText': 'The photo was saved, but text recognition failed (you can edit it manually from the drafts list).',
