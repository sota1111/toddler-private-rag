...
export const messages: Record<Lang, Messages> = {
  ja: {
    ...
    'settings.municipalityRegister': '登録',
    'settings.municipalityRegistered': '登録しました',
    // 子どもの登録・管理 (SOT-1368)
    ...
    'settings.childrenGroupLabel': '組・クラス',
    'settings.childrenGroupPlaceholder': '組・クラス（任意）',
    ...
    // 個別配慮プロファイル (SOT-2732)
    'careProfile.title': '個別配慮プロファイル',
    'careProfile.description': 'お子さまごとのアレルゲン・配慮カテゴリ・自由記述を登録できます。おたより照合時の「要確認」の判断材料になります。',
    'careProfile.childLabel': 'お子さま',
    'careProfile.childPlaceholder': 'お子さまを選択',
    'careProfile.noChildren': '先に「お子さまの登録」からお子さまを追加してください。',
    'careProfile.loading': '読み込み中…',
    'careProfile.loadError': 'プロファイルの取得に失敗しました。',
    'careProfile.allergensLabel': 'アレルゲン',
    'careProfile.careCategoriesLabel': '配慮カテゴリ',
    'careProfile.freeTextLabel': '自由記述',
    'careProfile.freeTextPlaceholder': '例: 卵は加熱少量なら可。念のため申告。',
    'careProfile.severityLabel': '重症度メモ',
    'careProfile.severityPlaceholder': '例: 少量でも重い症状が出る。エピペン携帯。',
    'careProfile.lastUpdated': '最終更新日',
    'careProfile.save': '保存',
    'careProfile.saving': '保存中…',
    'careProfile.saved': '保存しました',
    'careProfile.saveError': '保存に失敗しました。',
    'careProfile.delete': 'プロファイルを削除',
    'careProfile.deleteConfirm': 'このお子さまのプロファイルを削除します。よろしいですか？',
    'careProfile.deleteConfirmButton': '削除する',
    'careProfile.deleting': '削除中…',
    'careProfile.deleteError': '削除に失敗しました。',
    'careProfile.cancel': 'キャンセル',
    'careProfile.allergen.egg': '卵',
    'careProfile.allergen.milk': '乳',
    'careProfile.allergen.wheat': '小麦',
    'careProfile.allergen.buckwheat': 'そば',
    'careProfile.allergen.peanut': '落花生',
    'careProfile.allergen.shrimp': 'えび',
    'careProfile.allergen.crab': 'かに',
    'careProfile.allergen.walnut': 'くるみ',
    ...
    'howto.deadlineTitle': '3. 提出書類の締切を自動で逆算する',
    'howto.deadlineBody': '就労証明書などの提出書類は、最終締切から逆算して「様式の入手 → 発行依頼 → 記入内容の確認 → 市町村へ提出」の準備タスクを、締切に間に合う日付付きで自動生成します。やること画面に順番に並ぶので、早めに動けます。',
    'howto.scheduleTitle': '4. カレンダーで予定を見る',
    'howto.scheduleBody': '「カレンダー」画面で、行事や締め切りを日付ごとに確認できます。',
    'howto.boardTitle': '5. 掲示板で今日・今週を把握する',
    'howto.boardBody': '「掲示板」画面（ホーム）で、今日・明日・今週・来週の予定やリマインドをまとめて確認できます。',
    'howto.askTitle': '6. わからないことを質問する',
    'howto.askBody': '「質問」画面で、登録したおたよりの内容について自然な言葉で質問できます。回答には根拠となるおたよりが表示されます。',
    'howto.settingsTitle': '7. 設定',
    ...
    // menu-calendar: カレンダーの「予定/献立」切替と献立詳細
    'schedule.modeEvents': '予定',
    'schedule.modeMenu': '献立',
    'schedule.menuListTitle': '献立',
    'schedule.menuEmpty': 'この月の献立はまだありません',
    'menu.lunch': '給食',
    'menu.morningSnack': '午前おやつ',
    'menu.afternoonSnack': '午後おやつ',
    'menu.ingredients': '主要食材',
    'menu.ingRed': '体をつくる',
    'menu.ingYellow': 'エネルギー',
    'menu.ingGreen': '調子を整える',
    'menu.ingOther': 'その他',
    'menu.nutrition': '栄養価',
    'menu.under3': '3歳未満',
    'menu.over3': '3歳以上',
    ...
    // attention item / 要確認（この子向け） (SOT-2734)
    ...
    'attention.evidenceProfile': '対応する配慮',
    'attention.evidenceConfidence': '信頼度',
    'attention.evidenceSource': '出典',
    'attention.source.menu_json': '献立',
    'attention.source.notice_text': 'おたより本文',
    'attention.source.llm': 'AI文脈確認',
    'attention.confidence.high': '高',
    'attention.confidence.medium': '中',
    'attention.confidence.low': '低（情報不足）',
    'attention.status.attention': '要確認',
    'attention.status.abstain': '情報不足のため要確認',
    'attention.confirm': '確認済',
    'attention.notApplicable': '非該当',
    'attention.reset': '未確認に戻す',
    'attention.reviewed.confirmed': '確認済',
    'attention.reviewed.not_applicable': '非該当（誤検出）',
    ...
    'records.deleteLinkedTasks': '関連タスクも削除する（{count}件）',
    ...
    'records.unarchive': 'アーカイブから戻す',
    'records.unarchiving': '戻しています…',
    'records.confirmUnarchive': '「{title}」をアーカイブから戻しますか？',
    'records.unarchiveError': 'アーカイブからの復帰に失敗しました。時間をおいて再度お試しください。',
    ...
    'records.rescheduleBaseDate': '提出目標日',
    'records.rescheduleSave': '提出目標日を変更',
    'records.rescheduling': '更新中…',
    'records.rescheduleDone': '提出目標日を変更し、付随タスク{count}件の日付をまとめてずらしました。',
    ...
    'create.confirmPdfLabel': 'PDF ファイル',
    'create.confirmRegister': 'この写真で登録',
    'create.confirmRegisterMulti': 'この{count}枚を登録',
    ...
    'create.autoSavedMultiDesc': '{count}枚の写真を登録しました。整理はバックグラウンドで進み、完了すると写真一覧に表示されます。',
    'create.autoSavedPartialFail': '{count}枚は保存に失敗しました。もう一度お試しください。',
    ...
    'drafts.confirmRevertSplit': '締切から逆算して分割した (n/N) のタスクをすべて削除しますか？（分割前のタスクは残ります）',
  ...
  en: {
    ...
    'settings.municipalityRegister': 'Register',
    'settings.municipalityRegistered': 'Registered',
    ...
    'settings.childrenGroupLabel': 'Group / Class',
    'settings.childrenGroupPlaceholder': 'Group / Class (optional)',
    ...
    // Care profile (SOT-2732)
    'careProfile.title': 'Care profile',
    'careProfile.description': 'Register allergens, care categories and free notes per child. Used to flag items that need review when matching newsletters.',
    'careProfile.childLabel': 'Child',
    'careProfile.childPlaceholder': 'Select a child',
    'careProfile.noChildren': 'Please add a child first from "Children".',
    'careProfile.loading': 'Loading…',
    'careProfile.loadError': 'Failed to load the profile.',
    'careProfile.allergensLabel': 'Allergens',
    'careProfile.careCategoriesLabel': 'Care categories',
    'careProfile.freeTextLabel': 'Free notes',
    'careProfile.freeTextPlaceholder': 'e.g. Small heated amounts of egg are OK. Declaring just in case.',
    'careProfile.severityLabel': 'Severity note',
    'careProfile.severityPlaceholder': 'e.g. Severe reaction even in small amounts. Carries an EpiPen.',
    'careProfile.lastUpdated': 'Last updated',
    'careProfile.save': 'Save',
    'careProfile.saving': 'Saving…',
    'careProfile.saved': 'Saved',
    'careProfile.saveError': 'Failed to save.',
    'careProfile.delete': 'Delete profile',
    'careProfile.deleteConfirm': 'Delete this child\'s profile. Are you sure?',
    'careProfile.deleteConfirmButton': 'Delete',
    'careProfile.deleting': 'Deleting…',
    'careProfile.deleteError': 'Failed to delete.',
    'careProfile.cancel': 'Cancel',
    'careProfile.allergen.egg': 'Egg',
    'careProfile.allergen.milk': 'Milk',
    'careProfile.allergen.wheat': 'Wheat',
    'careProfile.allergen.buckwheat': 'Buckwheat',
    'careProfile.allergen.peanut': 'Peanut',
    'careProfile.allergen.shrimp': 'Shrimp',
    'careProfile.allergen.crab': 'Crab',
    'careProfile.allergen.walnut': 'Walnut',
    ...
    'howto.deadlineTitle': '3. Auto-plan document deadlines backward',
    'howto.deadlineBody': 'For submission documents such as an employment certificate, the app plans backward from the final deadline and auto-generates the prep tasks — obtain the form, request issuance, check the entries, submit to the municipality — each dated so you finish in time. They line up in order on the Tasks screen so you can start early.',
    'howto.scheduleTitle': '4. See events on the calendar',
    'howto.scheduleBody': 'The Calendar screen shows events and deadlines by date.',
    'howto.boardTitle': '5. Today & this week on the board',
    'howto.boardBody': "The Board (home) screen gathers today, tomorrow, this week and next week's items and reminders.",
    'howto.askTitle': '6. Ask a question',
    ...
    'howto.settingsTitle': '7. Settings',
    ...
    // menu-calendar: calendar "Events / Menu" toggle and menu detail
    'schedule.modeEvents': 'Events',
    'schedule.modeMenu': 'Menu',
    'schedule.menuListTitle': 'Menu',
    'schedule.menuEmpty': 'No menu for this month yet',
    'menu.lunch': 'Lunch',
    'menu.morningSnack': 'Morning snack',
    'menu.afternoonSnack': 'Afternoon snack',
    'menu.ingredients': 'Main ingredients',
    'menu.ingRed': 'Body-building',
    'menu.ingYellow': 'Energy',
    'menu.ingGreen': 'Regulating',
    'menu.ingOther': 'Other',
    'menu.nutrition': 'Nutrition',
    'menu.under3': 'Under 3',
    'menu.over3': '3 and over',
    'menu.energy': 'Energy',
    ...
    'attention.evidenceProfile': 'Related care',
    'attention.evidenceConfidence': 'Confidence',
    'attention.evidenceSource': 'Source',
    'attention.source.menu_json': 'Menu',
    'attention.source.notice_text': 'Notice text',
    'attention.source.llm': 'AI context check',
    'attention.confidence.high': 'High',
    'attention.confidence.medium': 'Medium',
    'attention.confidence.low': 'Low (insufficient info)',
    'attention.status.attention': 'Needs check',
    'attention.status.abstain': 'Needs check (insufficient info)',
    'attention.confirm': 'Confirmed',
    'attention.notApplicable': 'Not applicable',
    'attention.reset': 'Reset to unchecked',
    'attention.reviewed.confirmed': 'Confirmed',
    'attention.reviewed.not_applicable': 'Not applicable (false positive)',
    ...
    'records.deleteLinkedTasks': 'Also delete linked tasks ({count})',
    ...
    'records.unarchive': 'Restore from archive',
    'records.unarchiving': 'Restoring…',
    'records.confirmUnarchive': 'Restore “{title}” from archive?',
    'records.unarchiveError': 'Failed to restore from archive. Please try again later.',
    ...
    'records.rescheduleBaseDate': 'Submission target date',
    'records.rescheduleSave': 'Change submission target date',
    'records.rescheduling': 'Updating…',
    'records.rescheduleDone': 'Submission target date changed; shifted the dates of {count} related task(s).',
    ...
    'create.autoDesc': 'Pick one or more photos to auto-read their contents, then continue to the confirmation screen.',
    'create.confirmHeading': 'Use this photo?',
    'create.confirmHeadingMulti': 'Use these {count} photos?',
    'create.confirmImageAlt': 'Preview of the selected photo',
    'create.confirmPdfLabel': 'PDF file',
    'create.confirmRegister': 'Register this photo',
    'create.confirmRegisterMulti': 'Register these {count} photos',
    ...
    'create.autoSavedMultiDesc': '{count} photos were registered. Organizing continues in the background and they will appear in the photo list when done.',
    'create.autoSavedPartialFail': '{count} photo(s) failed to save. Please try again.',
    ...
    'drafts.revertSplit': 'Revert to a single task',
    'drafts.confirmRevertSplit': 'Delete all the (n/N) deadline-based split tasks? (The original pre-split task is kept.)',
