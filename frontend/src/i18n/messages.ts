...
export const messages: Record<Lang, Messages> = {
  ja: {
    ...
    'create.confirmTranscriptionHeading': '文字起こし',
    'create.confirmTranscribing': '文字起こし中…',
    'create.confirmTranscribeFail': '文字起こしに失敗しました。登録は可能です。',
    'create.confirmTranscribeEmpty': '文字を読み取れませんでした。',
  ...
  en: {
    ...
    'create.confirmTranscriptionHeading': 'Transcription',
    'create.confirmTranscribing': 'Transcribing…',
    'create.confirmTranscribeFail': 'Transcription failed. You can still register.',
    'create.confirmTranscribeEmpty': 'No text could be read.',
