    ...
    <div className="w-full lg:max-w-4xl lg:mx-auto pb-12">
      ...
      <div className="flex items-start justify-between gap-3 mb-6">
        ...
        <button
          ...
          disabled={isFetching}
          className="flex-shrink-0 px-4 py-2 text-sm font-medium text-foreground bg-surface border border-border rounded-md hover:bg-surface-muted disabled:opacity-50"
        >
          {isFetching ? t('drafts.refreshing') : t('drafts.refresh')}
        </button>
      </div>
